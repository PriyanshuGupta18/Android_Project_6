        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    ScaledImage=makeSmall(SelectImage,300);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode==2&&requestCode==RESULT_OK&&data!=null)
        {
            try {
                ...
                {
                    SelectImage=MediaStore.Images.Media.getBitmap(this.getContentResolver(),data.getData());
                }
                imageViewAddImage.setImageBitmap(SelectImage);
            } catch (IOException e) {
                e.printStackTrace();
            }
